...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark bg-navy elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
        <a href="#" class="brand-link bg-navy text-sm">
                  ...
                  <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <nav class="mt-4">
                      ...
                      <li class="nav-item dropdown">
                          <a href="http://localhost/scheduler/admin/schedules/user-register.php" class="nav-link nav-home">
                        ...
                        <li class="nav-item dropdown">
                      <a href="http://localhost/scheduler/login1.php" class="nav-link nav-assembly_hall">
                        <i class="nav-icon fas fa-door-open"></i>
                        <p>
                          Login 
                        </p>
